    ...
    pages: [
        {
            ...
            text: '祖母を焼いた日は、よく晴れていた。\n' +
                  '村の者が何人か来て、心ばかりの花を手向けて、それぞれの畑へ帰っていった。私は最後まで残って、骨を拾った。持ち上げると、思っていたよりずっと軽かった。\n\n' +
                  '家に戻る。この家の戸を開けるのは、何年ぶりだろう。'
        },
        {
            title: '証文',
            text: '帳場の下から、束ねた紙が出てきた。薬礼、往診、街から取り寄せた薬。\n' +
                  '祖母が寝付いてからの二年ぶんだ。\n' +
                  '足していくと、八千になった。\n\n' +
                  '借りた先の名は、はっきり書いてある。期日は一周忌の朝。\n' +
                  '返すつもりでいたのだと思う。何事にもきっちりした人だったから。'
        },
        {
            title: '売り物',
            text: 'この店を売れば、何年ぶんかの薬代にはなったはずだ。土地も、抽斗の中身も、まとめて。\n' +
                  '祖母はそれをしなかった。\n\n' +
                  '十何年も帰らなかった私のために、ここを帰る場所として守っていてくれたのかもしれない。\n\n' +
                  'いま売れば、八千は返せる。返せてしまう。\n' +
                  '期日に足りなければ、証文どおり、この家と店は人手に渡る。それを自分の手で先にするだけのことだ。\n\n' +
                  'それでも、帳場の柱には背丈をはかった傷が残っている。乳鉢は、祖母が置いていた場所にある。\n' +
                  '売りたくない。私も、まだあきらめたくない。'
        },
        {
            title: '家の中',
